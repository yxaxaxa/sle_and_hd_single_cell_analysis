...
features=[i for i in features if i in data.index.values]
...
### split data into MS and normal part
...
ms_pbmc=pd.DataFrame(rfc.feature_importances_)
ms_pbmc['feature_importance']=features
ms_pbmc.to_csv('./model/ms_pbmc_feature_importance_bulk.csv')
...
mpl.rcParams['pdf.fonttype']=42
mpl.rcParams['ps.fonttype']=42
plt.savefig('./figure6_and_7/7cms_pbmc_bulk_auc.pdf',width=4,height=5)
...
mpl.rcParams['pdf.fonttype']=42
mpl.rcParams['ps.fonttype']=42
plt.savefig('./figure6_and_7/7F_ms_pbmc_bulk.pdf',width=15,height=5)
