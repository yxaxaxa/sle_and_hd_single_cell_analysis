...
# # RA synovial biopsy data for machine learning
...
### split data into RA and normal part
...
ra_synovial=pd.DataFrame(rfc.feature_importances_)
ra_synovial['feature_importance']=features
ra_synovial.to_csv('./model/ra_synovial_feature_importance_bulk.csv')
...
mpl.rcParams['pdf.fonttype']=42
mpl.rcParams['ps.fonttype']=42
plt.savefig('./figure6_and_7/7b_ra_synovial_bulk_auc.pdf',width=4,height=5)
...
ax.set_title("Feature importance for RA bulk RNA synovial biopsy model", fontsize=15)
plt.xticks(rotation = 90)
mpl.rcParams['pdf.fonttype']=42
mpl.rcParams['ps.fonttype']=42
plt.savefig('./figure6_and_7/7e_ra_syonivial_bulk.pdf',width=15,height=5)
